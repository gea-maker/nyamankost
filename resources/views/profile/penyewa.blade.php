        ...
        <div>
            ...
            <nav class="mt-10">
                ...
                <div class="pt-6 pb-2 border-t border-indigo-500/50 mt-6">
                    ...
                    <a href="{{ route('profile.edit') }}" class="flex items-center px-6 py-3 text-white bg-indigo-800 border-l-4 border-white font-bold transition">
    ...
    <div class="flex-grow flex flex-col overflow-hidden">
        ...
        <header class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shadow-sm">
            <div class="flex items-center">
                ...
                <div class="relative mx-4 lg:mx-0 flex items-center gap-3">
                    ...
                    <p class="text-sm text-gray-500">Kelola informasi akun penyewa Anda</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                <div class="text-right hidden sm:block">
                    ...
                    <p class="text-xs text-indigo-500 font-medium">Penyewa</p>
                </div>
        ...
        <main class="flex-1 overflow-y-auto p-6 lg:p-10 bg-gray-50">
            ...
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                {{-- PROFILE HERO CARD --}}
                <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-3xl p-8 relative overflow-hidden shadow-xl">
                    ...
                    <div class="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        ...
                        <div class="flex-grow">
                            <p class="text-indigo-200 text-xs font-bold uppercase tracking-widest mb-1">Penyewa</p>
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-3">
                                <span class="bg-white/10 text-white text-xs px-3 py-1 rounded-full font-semibold border border-white/20">
                                    <i class="fa-solid fa-user mr-1"></i> Penyewa
                                </span>
                                @if($user->no_hp)
                                <span class="bg-white/10 text-indigo-100 text-xs px-3 py-1 rounded-full border border-white/10">
                ...
                <div class="flex items-center p-4 text-green-800 border border-green-300 rounded-xl bg-green-50">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-red-100 p-8">
                    ...
                    <p class="text-sm text-gray-500 mb-5">Menghapus akun akan menghapus semua data Anda secara permanen dari sistem. Pastikan Anda yakin sebelum melanjutkan.</p>
